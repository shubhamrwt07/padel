...
class CustomButton extends StatelessWidget {
  ...
  static const double _heightRatio = 0.16766467065868262;
  ...
  Widget build(BuildContext context) {
    final double height = width * _heightRatio;
...
class RPSCustomPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawCircle(Offset(size.width * 0.9251497, size.height * 0.5),
        size.width * 0.06586826, paint1Fill);
